...
REM Command: --------------------------------------------------
REM Display only date string from metadata
call %~dp0ffprobe -v quiet -print_format compact=print_section=0:nokey=1:escape=csv -show_entries format_tags=creation_time "%~1"
